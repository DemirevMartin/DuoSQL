...
# 1 TABLE
def get_auto_test_agg_all_3(limit):
    return f"""
DROP VIEW IF EXISTS prob_view CASCADE;
...
# 3 TABLES
def get_auto_test_where_having_1(limit):
    return f"""
DROP VIEW IF EXISTS prob_view CASCADE;
DROP VIEW IF EXISTS agg_view CASCADE;
...
# 4 TABLES
def get_auto_test_large_query_3(limit):
    return f"""
DROP VIEW IF EXISTS prob_view CASCADE;
DROP VIEW IF EXISTS agg_view CASCADE;
...
def get_auto_tests(limit):
    auto_test_agg_6 = get_auto_test_agg_6(limit)
    auto_test_agg_all_3 = get_auto_test_agg_all_3(limit)
    auto_test_where_having_1 = get_auto_test_where_having_1(limit)
    auto_test_large_query_3 = get_auto_test_large_query_3(limit)

    # NOTE: We switch auto_test_agg_6 and auto_test_agg_all_3 because the former has more tables than the latter.
    return [auto_test_agg_all_3, auto_test_agg_6, auto_test_where_having_1, auto_test_large_query_3]
